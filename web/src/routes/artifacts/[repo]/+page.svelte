  ...
  {:else if repository}
      ...
      <div class="flex items-center justify-between">
        <div class="inline-flex items-start">
          ...
          <div class="ml-4">
            ...
            <div class="mt-2 prose prose-sm max-w-2xl">
    ...
    {#if artifacts_list.length === 0}
      <div class="text-center py-12 bg-white rounded-lg shadow-sm">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">No artifacts</h3>
            ...
            {#each artifacts.filteredArtifacts[repository.id] || [] as artifact (artifact.created_at)}
              <tr class="hover:bg-gray-100">
                ...
                <td
                  ...
                  onclick={() => artifactDetails(artifact)}
                >
                  {formatDistance(new Date(artifact.updated_at), new Date(), {
                    addSuffix: true,
                  })}
                </td>
                <td
